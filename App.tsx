...
const App: React.FC = () => {
  ...
  // Watch for "Initiate" state (Palm Open or Click) to trigger envelope with 2s delay and 5s auto-close
  useEffect(() => {
    ...
    if (treeState === 'CONE') {
      ...
      if (!openPalmTimer.current && !isEnvelopeOpen) {
        ...
        openPalmTimer.current = window.setTimeout(() => {
          ...
          // Auto-fade after 5 seconds of visibility
  ...
  return (
    ...
    >
      ...
      <BlessingEnvelope isOpen={isEnvelopeOpen} name="Jack" />
